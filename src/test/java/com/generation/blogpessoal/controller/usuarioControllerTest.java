...
public class usuarioControllerTest {
	...
	void start() {
		...
		// 0L representa o auto increment do id
	...
	public  void  deveCriarUmUsuario() {
		...
		HttpEntity<Usuario> corpoResquisicao = new HttpEntity<Usuario>(new Usuario(null, "vitoria", "vitoria@gmail.com",
				"12345678", "-"));
		
		ResponseEntity<Usuario> corpoResposta = testRestTemplate.exchange("/usuarios/cadastrar", HttpMethod.POST,
				corpoResquisicao, Usuario.class);
